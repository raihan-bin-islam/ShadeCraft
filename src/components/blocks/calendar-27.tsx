...
export default function Calendar27() {
  ...
  return (
    <Card className="@container/card w-full max-w-xl py-4 px-0 h-full">
      <CardHeader className="flex flex-col border-b [.border-b]:pb-6 px-4 @md/card:grid">
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button variant="outline">
                <CalendarIcon />
                {range?.from && range?.to ? `${range.from.toLocaleDateString()} - ${range.to.toLocaleDateString()}` : "June 2025"}
              </Button>
            </PopoverTrigger>
      ...
      <CardFooter className="border-t [.border-t]:pt-6 px-4">
