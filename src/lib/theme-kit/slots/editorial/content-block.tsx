...
export const ContentBlock: SlotComponent = () => {
  return (
    <article className="mx-auto max-w-2xl py-12 px-6 space-y-6">
      ...
      <p className="text-base leading-relaxed text-foreground">
        Existing tools excel at the mechanics&mdash;they can generate perfectly proportioned scales and accessible color combinations. But they miss the human layer. They don&apos;t ask about your product&apos;s voice, your brand&apos;s evolution, or the emotional journey your users should experience. They treat theme generation as a cosmetic exercise rather than a strategic one. The result is a thousand digital products that look competent but interchangeable.
      </p>

      <blockquote className="border-l-4 border-primary pl-6 py-2 my-8 text-lg italic text-foreground">
      ...
      <p className="text-base leading-relaxed text-foreground">
        When a product team understands the narrative, they become stewards of the system rather than passive consumers. They know why the primary color is a certain shade of blue&mdash;because it needs to feel reliable and modern simultaneously. They understand the type hierarchy not as arbitrary sizes, but as a vocal register that guides attention and creates cognitive landmarks. This understanding multiplies their decision-making power.
      </p>

      <p className="text-base leading-relaxed text-foreground">
        Building narrative into a design system means being intentional from the start. It means asking hard questions about brand values, user perception, and emotional goals. It means documenting not just the rules, but the reasoning. And it means creating tools that help teams apply those rules with understanding, not just compliance. That&apos;s the difference between a system and a shortcut&mdash;and it&apos;s the future of design system evolution.
      </p>
    </article>
  );
};
